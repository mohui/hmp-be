 ...
 * @param _data  
 */
data class BodyTemperaturePageListResult(
    ...
    @field:Valid
    @field:JsonProperty("data") val _data: kotlin.collections.List<BodyTemperatureResult>? = null
) {
