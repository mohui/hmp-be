...
/**
 * AnswerResultToQuestionsOption
 * @param questionsId  
 * @param optionId  
 * @param optionValue  选项结果
 * @param questionsAnsweredCount  同一问题回答次数
 * @param optionCode  选项编码
 * @param optionScore  
 */
data class AnswerResultToQuestionsOption(
    ...
    @field:JsonProperty("questionsAnsweredCount", required = true) val questionsAnsweredCount: kotlin.Int,
