...
@Component
class CerebralStrokeBehaviorEvaluatePostProcessorsHandler(
    ...
    override val examinationPaperCode = "CEREBRAL_STROKE_BEHAVIOR"

    override val healthPlanType = HealthPlanType.CEREBRAL_STROKE_BEHAVIOR_VISIT
