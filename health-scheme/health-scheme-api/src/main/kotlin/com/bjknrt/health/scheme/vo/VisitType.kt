...
/**
* 人群分类（HYPERTENSION-高血压,DIABETES-糖尿病,ACUTE_CORONARY_DISEASE-冠心病,CEREBRAL_STROKE-脑卒中,COPD-慢阻肺,LEAVE_HOSPITAL_VISIT-脑卒中出院随访）
* Values: HYPERTENSION,DIABETES,ACUTE_CORONARY_DISEASE,CEREBRAL_STROKE,COPD,LEAVE_HOSPITAL_VISIT
*/
enum class VisitType(val value: kotlin.String) {
