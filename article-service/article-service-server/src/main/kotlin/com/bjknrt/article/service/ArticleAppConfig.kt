...
@Configuration
@ImportSqlEx(Repository::class, factoryName = "hmpArticleServiceServerFactory") // sqlex
class ArticleAppConfig(val dataSource: DataSource) {

    /**
     * Sqlex数据源工厂
     */
    @Bean
    fun hmpArticleServiceServerFactory(): DaoFactory {
