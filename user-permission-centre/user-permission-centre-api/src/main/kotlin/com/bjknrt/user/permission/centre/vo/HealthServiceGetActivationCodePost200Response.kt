 ...
 */
data class HealthServiceGetActivationCodePost200Response(
    ...
    @field:Valid
    @field:JsonProperty("record", required = true) val record: kotlin.collections.List<HealthServiceGetActivationCodePost200ResponseRecordInner>,
