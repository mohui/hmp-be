...
data class UserInfo(
    ...
    @field:Valid
    @field:JsonProperty("identityTagList", required = true) val identityTagList: kotlin.collections.List<IdentityTag>,
    ...
    @field:Valid
    @field:JsonProperty("orgList") val orgList: kotlin.collections.List<Org>? = null,

    @field:Valid
    @field:JsonProperty("roleList") val roleList: kotlin.collections.List<RoleInfo>? = null,

    @field:Valid
    @field:JsonProperty("regionList") val regionList: kotlin.collections.List<Region>? = null,
